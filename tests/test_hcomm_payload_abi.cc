...
int main() {
  ...
  static_assert(FLUME_HCOMM_PAYLOAD_COPY_SEMANTIC_VERSION == 13,
  ...
  static_assert(FLUME_HCOMM_PAYLOAD_STATUS_WORD_COUNT == 15,
                "payload status word count changed");
  static_assert(FLUME_HCOMM_PAYLOAD_STATUS_SCHEMA_VERSION == 5,
