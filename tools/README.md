...
`payload_semantic_v12=present`, `payload_semantic_v13=present`, `payload_semantic_v14=present`, `payload_semantic_v15=present`, `payload_semantic_v16=present`, `payload_semantic_v17=present`, `payload_semantic_v18=present`、`payload_pattern=strict-v1`、rank0 source
...
`FlumeHcommPayloadCopyDirectAclrtKernel` 或缺 semantic v18 / official-p2p
...
ABI：payload ABI v4、semantic v18、status schema v7、status word count
...
ABI v4 marker、semantic v18 marker、official-p2p marker、comm-acquire marker、status schema marker
