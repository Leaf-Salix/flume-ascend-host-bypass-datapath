...
#define FLUME_HCOMM_PAYLOAD_COPY_SEMANTIC_VERSION 12U
...
#define FLUME_HCOMM_PAYLOAD_STATUS_WORD_COUNT 14U
#define FLUME_HCOMM_PAYLOAD_STATUS_SCHEMA_VERSION 4U
...
#define FLUME_HCOMM_PAYLOAD_TRACE_WORD_COUNT \
  (FLUME_HCOMM_PAYLOAD_TRACE_HEADER_WORD_COUNT + \
   ...
   FLUME_HCOMM_PAYLOAD_TRACE_EVENT_CAPACITY)
#define FLUME_HCOMM_PAYLOAD_TRACE_SCHEMA_VERSION 2U
