...
#define FLUME_HCOMM_PAYLOAD_COPY_SEMANTIC_VERSION 7U
...
#define FLUME_HCOMM_PAYLOAD_TRACE_WORD_COUNT 16U
#define FLUME_HCOMM_PAYLOAD_TRACE_SCHEMA_VERSION 1U
...
#define FLUME_HCOMM_PAYLOAD_TRACE_EVENT_KERNEL_EXIT 30U
