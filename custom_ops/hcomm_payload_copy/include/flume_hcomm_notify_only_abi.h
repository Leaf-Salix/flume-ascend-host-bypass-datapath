...
#define FLUME_HCOMM_PAYLOAD_COPY_SEMANTIC_VERSION 13U
...
#define FLUME_HCOMM_PAYLOAD_STATUS_WORD_COUNT 15U
#define FLUME_HCOMM_PAYLOAD_STATUS_SCHEMA_VERSION 5U
