...
payload_echo=passed
payload_thread_notify_order=batch-end-before-host-notify|not-used
...
`payload_echo=passed`, `payload_thread_notify_order=...`, source/received/expected checksum match,
